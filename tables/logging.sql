CREATE VIEW tmp_view AS
 select log_id, log_type, log_action, to_char(log_timestamp at time zone 'UTC', 'YYYYMMDDHH24MISS') log_timestamp, log_user, log_user_text, log_namespace, log_title, log_page, log_comment, log_params, log_deleted FROM logging;
