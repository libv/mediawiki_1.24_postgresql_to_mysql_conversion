...
CREATE VIEW tmp_view AS
 select ar_id, ar_namespace, ar_title, ar_text, ar_comment, ar_user, ar_user_text, to_char(ar_timestamp at time zone 'UTC', 'YYYY:MM:DD:HH24:MI:SS') ar_timestamp, ar_minor_edit, ar_flags, ar_rev_id, ar_text_id, ar_deleted, ar_len, ar_page_id, ar_parent_id, ar_sha1, ar_content_model, ar_content_format FROM archive;
