CREATE VIEW tmp_view AS
 select pt_namespace, pt_title, pt_user, pt_reason, to_char(pt_timestamp at time zone 'UTC', 'YYYYMMDDHH24MISS') pt_timestamp, to_char(pt_expiry at time zone 'UTC', 'YYYYMMDDHH24MISS') pt_expiry, pt_create_perm FROM protected_titles;
