CREATE VIEW tmp_view AS
 select oi_name, oi_archive_name, oi_size, oi_width, oi_height, oi_bits, oi_description, oi_user, oi_user_text, to_char(oi_timestamp at time zone 'UTC', 'YYYYMMDDHH24MISS') oi_timestamp, oi_metadata, oi_media_type, oi_major_mime, oi_minor_mime, oi_deleted, oi_sha1 FROM oldimage;
