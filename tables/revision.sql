CREATE VIEW tmp_view AS
 select rev_id, rev_page, rev_text_id, left(rev_comment, 255) rev_comment, rev_user, rev_user_text, to_char(rev_timestamp at time zone 'UTC', 'YYYYMMDDHH24MISS') rev_timestamp, rev_minor_edit, rev_deleted, rev_len, rev_parent_id, rev_sha1, rev_content_model, rev_content_format FROM revision;
